...
public class ExpressionGenerator extends CodeGenerator
{
     ...
     */
    public void emitExpression(jsParser.ExpressionContext ctx)
    {
     ...
     */
    public void emitSimpleExpression(jsParser.SimpleExpressionContext ctx)
    {
     ...
     */
    public void emitTerm(jsParser.TermContext ctx)
    {
     ...
     */
//    public void emitNotFactor(jsParser.NotFactorContext ctx)
//    {
...
//    }
     ...
     */
    public void emitLoadValue(jsParser.VariableContext varCtx)
    {
        ...
        if (modifierCount > 0)
        {
            jsParser.ModifierContext lastModCtx =
     ...
     */
    public Typespec emitLoadVariable(jsParser.VariableContext varCtx)
    {
        SymtabEntry variableId = varCtx.entry;
        System.out.println("varId in emitLoadVariable() in ExpressionGenerator.java: " + variableId.getName().toLowerCase());
        ...
        {
            jsParser.ModifierContext modCtx = varCtx.modifier().get(i);
    ...
    private Typespec emitLoadArrayElementAccess(
            jsParser.IndexListContext indexListCtx,
                                    Typespec elmtType, boolean lastModifier)
    {
        ...
        {
            jsParser.IndexContext indexCtx = indexListCtx.index().get(i);
    ...
    private void emitLoadRecordFieldValue(
            jsParser.FieldContext fieldCtx, Typespec recordType)
    {
     ...
     */
    public void emitLoadIntegerConstant(jsParser.NumberContext intCtx)
    {
     ...
     * @parm intCtx the IntegerConstantContext.
     */
    public void emitLoadRealConstant(jsParser.NumberContext realCtx)
    {
        float value = Float.parseFloat(realCtx.getText());
        emitLoadConstant(value);
    }
    public void emitLoadDoubleConstant(jsParser.NumberContext realCtx)
    {
        float value = Float.parseFloat(realCtx.getText());
        emitLoadConstant(value);
    }
