...
{    
     ...
     */
    public void emitComment(jsParser.StatementContext ctx)
    {
    ...
    public void emitDirectiveForValue(Directive directive,
                              String operand1, String operand2,
                              String operand3)
    {
    ...
    public void emit(Instruction instruction, String operand1, String operand2, String operand3)
    {
        objectFile.println("\t" + instruction.toString() +
                "\t" + operand1 + " " + operand2);
        objectFile.println(operand3);
        objectFile.flush();
...
//        }
    ...
    public String typeDescriptor(Typespec pascalType)
    {
        ...
        else if (pascalType == Predefined.doubleType)    str = "F";
    ...
    public String objectTypeName(Typespec pascalType)
    {
        ...
        else if (pascalType == Predefined.doubleType)    str = "java/lang/Float";
