...
public class TypeChecker
{
     ...
     */
    public static boolean isDouble(Typespec type)
    {
     ...
     */
    public static boolean isIntegerOrDouble(Typespec type)
    {
     ...
     */
    public static boolean isAtLeastOneDouble(Typespec type1, Typespec type2)
    {
        return    (isDouble(type1) && isDouble(type2))
               || (isDouble(type1) && isInteger(type2))
               || (isInteger(type1) && isDouble(type2));
    }
                                                  ...
                                                  Typespec valueType)
    {
        ...
        // real := integer
        else if (isDouble(targetType) && isInteger(valueType)) compatible = true;
                                                  ...
                                                  Typespec type2)
    {
        if ((type1 == null) || (type2 == null)) {
            System.out.println("either type1 or type2 is null. " +"type1:" + type1 + " type2:" + type2 );
            return false;
        }
        ...
        else if (isAtLeastOneDouble(type1, type2)) compatible = true;
